...
insert  into `tab_err`(`errid`,`bid`,`type`,`date`) values (1,2,'1111','2020-02-07'),(2,11,'aaaa','2020-02-26'),(3,13,'xxxx','2020-02-27');
...
CREATE TABLE `tab_jiehuan` (
  ...
  CONSTRAINT `FK_yh` FOREIGN KEY (`userid`) REFERENCES `tab_yh` (`uid`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tab_jiehuan` */

insert  into `tab_jiehuan`(`jiehuanid`,`bid`,`bzldid`,`bdate`,`todate`,`jiehuanstatus`,`userid`) values (1,1,1,'2020-02-06','2020-02-21','0',1),(2,11,1,'2020-02-07','2020-02-07','0',1),(3,14,1,'2020-02-07','2020-02-08','0',1),(4,1,1,'2020-02-08','2020-02-08','0',1),(5,1,1,'2020-02-08','2020-02-08','0',1),(6,13,1,'2020-02-14','2020-02-14','0',1);
