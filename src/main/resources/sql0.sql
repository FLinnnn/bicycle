...
insert  into `tab_err`(`errid`,`bid`,`type`,`date`) values (1,2,'1111','2020-02-07');
...
insert  into `tab_jiehuan`(`jiehuanid`,`bid`,`bzldid`,`bdate`,`todate`,`jiehuanstatus`,`userid`) values (1,1,1,'2020-02-06','2020-02-21','1',1);
