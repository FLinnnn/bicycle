...
insert  into `tab_err`(`errid`,`bid`,`type`,`date`) values (1,2,'1111','2020-02-07'),(2,11,'5555','2020-02-01');
...
insert  into `tab_jiehuan`(`jiehuanid`,`bid`,`bzldid`,`bdate`,`todate`,`jiehuanstatus`,`userid`) values (1,1,1,'2020-02-06','2020-02-21','1',1),(2,11,1,'2020-02-07','2020-02-07','0',1),(3,14,1,'2020-02-07',NULL,'1',1);
...
insert  into `tab_yh`(`uid`,`username`,`password`,`uname`,`birthday`,`sex`,`telephone`,`email`) values (1,'xiaoming','xiaoming','小明','2020-01-01','1','12345678901','123@qq.com'),(2,'yangfulin','yyyyyyy','杨扶林','2020-02-05','1','11111111111','2@qq.com');
