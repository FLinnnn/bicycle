...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">自行车分类</a>
        </div>

        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li ><a href="mainGLY.jsp">主页<span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="#" id="GLYbicyclebtn">车辆管理</a></li>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-10">
            ...
            <button class="btn btn-danger" id="bicycle_delect_all_btn"><span class="glyphicon glyphicon-scissors" aria-hidden="true"></span>删除
            </button>
    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <button class="btn btn-primary" id="btncid1">山地自行车
            </button>
            <button class="btn btn-success" id="btncid2">降速自行车
            </button>
            <button class="btn btn-info" id="btncid3">林道自行车
            </button>
            <button class="btn btn-warning" id="btncid4">越野自行车
            </button>
            <button class="btn btn-danger" id="btncid5">竞赛自行车
            </button>
            <button class="btn btn-primary" id="btncid6">BMX自行车
            </button>
            <button class="btn btn-success" id="btncid7">少儿自行车
            </button>
            <button class="btn btn-info" id="btncid8">学生自行车
            </button>
            <button class="btn btn-danger" id="btncid9">全部自行车
            </button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="${APP_PATH}/bicycleCRUD" id="savenewbicycle" enctype="multipart/form-data" method="post">
...
<div class="modal fade" id="bicycleUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal"  action="${APP_PATH}/bicycleupdateCRUD" id="updatebicycle" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status1_update_input" value="1" checked="checked"> 正常
                            </label>
                            <label class="radio-inline">
...
<script>
    ...
    function to_pagewithcid(pn,cid) {
        $.ajax({
            url: "${APP_PATH}/bicyclewithcidCRUD",
            data: "pn=" + pn+"&cid=" + cid,
            type: "GET",
            success: function (result) {
                build_bicycle_table(result);
